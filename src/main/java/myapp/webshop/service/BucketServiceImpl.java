...
import myapp.webshop.dao.BucketRepository;
import myapp.webshop.dao.ProductRepository;
import myapp.webshop.dto.BucketDTO;
import myapp.webshop.dto.BucketDetailDTO;
    ...
    public BucketDTO getBucketByUser(String name) {
        ...
        for (Product product : products) {
            ...
            if (bucketDetail == null) {
                ...
                bucketDetail.setAmount(bucketDetail.getAmount().add(new BigDecimal(1.0)));
                bucketDetail.setSum(bucketDetail.getSum()+Double.valueOf(product.getPrice().toString()));
            }
        }
